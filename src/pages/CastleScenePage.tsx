      ...
      <div className="relative z-20 flex flex-col items-center justify-between min-h-screen py-10">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-8 px-4 w-full max-w-5xl">
          {choices.map((str, i) => (
            <div
              key={i}
              className="pixel-box w-full sm:w-72 max-w-sm h-28 flex items-center justify-center text-center text-yellow-100 text-sm cursor-pointer hover:scale-105 transition-transform animate-choicePop"
