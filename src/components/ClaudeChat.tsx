...
const ClaudeChat: React.FC<ResultPageProps> = ({
  ...
  const { responses, loading, error, askClaude } = useClaudeAPI();
    ...
    >
      ...
      >
        ...
        <div className="bg-indigo-900/70 rounded-xl shadow-lg px-8 py-6 text-white w-auto">
          <ul className="list-disc text-left space-y-2 font-pixel">
            <p
              style={{
                color: "#ebdbff",
                fontSize: "18px",
            ...
            <button
              ...
              style={{
                ...
                padding: "10px",
                backgroundColor:
                  scenarioLoading || loading ? "#ccc" : "#7212cc",
                color: "#ebdbff",
                border: "none",
                borderRadius: "6px",
                marginBottom: "15px",
